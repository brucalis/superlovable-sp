...
<html lang="es-419">
  ...
  <body>
    <div class="card">
      ...
      <p>Algo salió mal. Puedes intentarlo de nuevo o volver al inicio.</p>
      <div class="actions">
...
async function getServerEntry() {
	if (!serverEntryPromise) serverEntryPromise = import("./server-BdQyjzka.mjs").then((n) => n.t).then((m) => m.default ?? m);
